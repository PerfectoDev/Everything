...
$.extend($.easing, {
  ...
  (function (t) {
    ...
    function n(e) {
        ...
        var orderQuantity = JSON.parse(localStorage.getItem('AdDtoCart'));
        var quantity = orderQuantity.quantity;
        if (i.hasClass("disabled")) {
            alert("Please select some product options before adding this product to your cart.");
        } else {
            if (productId === 'False') {
                var productName = i.closest(".product-single").find(".product-title").text();
                var alertHtml = '<div class="alert alert-error alert-cart-product mb-2">\
                                    <p class="mb-0 ls-normal">“' + productName + '” اللون والحجم المطلوبين غير متوفرين لهذا المنتج.</p>\
                                    <a href="#" class="btn btn-link btn-close" aria-label="button"><i class="close-icon"></i></a>\
                                </div>';
                i.closest(".product-single").before(alertHtml); 
            }else if(productCount < quantity) { 
              var productName = i.closest(".product-single").find(".product-title").text();
              var alertHtml = '<div class="alert alert-error alert-cart-product mb-2">\
                                  <p class="mb-0 ls-normal">“' + productName + '” الكمية المطلوبة لهذا المنتج غير متاحة</p>\
                                  <a href="#" class="btn btn-link btn-close" aria-label="button"><i class="close-icon"></i></a>\
                              </div>';
              i.closest(".product-single").before(alertHtml); 
              return
                ...
                if (a.length) {
                    ...
                    var successHtml = '<div class="alert alert-success alert-cart-product mb-2 .alert-error.alert-bg">\
                                        <p class="mb-0 ls-normal">“' + i.closest(".product-single").find(".product-title").text() + '” تم اضافة المنتج الي سلة مشترياتك بنجاح</p>\
                                        <a href="#" class="btn btn-link btn-close" aria-label="button"><i class="close-icon"></i></a>\
                                    </div>';
                    i.closest(".product-single").before(successHtml);
                }
            }
