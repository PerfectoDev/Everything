               ...
               <div class="product product-single row">
                                ...
                                <div class="col-md-6 mb-4 mb-md-6">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        <h2 class="product-title">${product.nameAr
                        }</h2>
                                        <div class="product-bm-wrapper">
                                            <figure class="brand">
                                        <img src="${domainImage}${product.brandImage
                        }" alt="Brand" width="102" height="48" />
                                            </figure>
                                            <div class="product-meta">
                                                <div class="product-categories">
                                          
                                       الفئة: <span class="product-category"><a href="#">${product.categoryNameAr
                        }</a></span>
                                                </div>
                                                <div class="product-sku">
                                                <div class="product-sku"> الرقم التسلسلى: <span>${product.id
                        }</span></div>
                                ...
                                <div class="product-price"><ins class="new-price">${product.price
                        }</ins>&ensp;ريال سعودي</div>

                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                    <span class="ratings" style="width: ${product.review + "0"
                        }%;"></span>
                ...
                `;
                    ...
                    fetch(
                        (ApiSimilar = `https://everyapi.webxy.net/Product/GetSimilarProducts?CategoryId=20&productId=${product_id}`)
                    )
                        .then((response) => response.json())
                        .then((data) => {
                            const domainImage = "https://everyui.webxy.net/";
                            const similarProductContainer =
                                document.getElementById("similar-project");
                    ...
                    <div class="swiper-slide product">
                        <figure class="product-media">
                            <a href="../../ar-product-details.html?id=${productData.productId
                                ...
                                <img id="similar-product-image" src="${domainImage}${productData.image}" alt="Product" width="300" height="338" />
                            </a>
                        ...
                        <div class="product-details">
                            <h4 class="product-name"><a href="../../ar-product-details.html?id=${productData.productId
                                        }">${productData.nameAr}</a></h4>
                            <div class="ratings-container">
                                <div class="ratings-full">
                                    <span class="ratings" style="width: ${productData.review * 20
                                        }%;"></span> <!-- Assuming review is a value between 0 and 5 -->
                                    <span class="tooltiptext tooltip-top"></span>
                                </div>
                                <a href="../../ar-product-details.html?id=${productData.productId
                                        }" class="rating-reviews">(${productData.review
                                        } تعليقات)</a>
                            </div>
